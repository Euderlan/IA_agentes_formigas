;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; PROJETO: Guerra de Formigueiros em Terreno Dinâmico
;; AUTORES:
;; DESCRIÇÃO: Simulação com formigas operárias e de solo, clima dinâmico,
;; comida derrubada por humanos, predadores (sapos) e obstáculos.
;; Ambiente: Cozinha com móveis, lixeira e áreas acessíveis ou não.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
to setup
  ...
  ; Criação das formigas operárias iniciais
  ...
  setup-patches                           ; Inicializa os patches do ambiente (comida, obstaculos etc.)

  ; Criação dos sapos predadores
...
ifelse total-food-world < 10 [
  set scarcity-mode? true
] [
  set scarcity-mode? false
]
  ...
  ; Verifica se precisa gerar novos sapos
  spawn-new-frogs
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; NOVOS PROCEDIMENTOS PARA ANIMAÇÃO DO FOGO  ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; RAINHA: MOVIMENTAÇÃO E REPRODUÇÃO ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
to move-queen
...
to reproduce
  if scarcity-mode? [ stop ]  ; Interrompe reprodução se estiver em escassez
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; FORMIGAS OPERARIAS BUSCA POR COMIDA ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
if meal-here != nobody [
  ...
  if ([food] of patch-here > 0) or ([food-counter?] of patch-here) [
    ...
    ; Ganha energia ao encontrar comida
...
to return-to-nest
  ifelse nest? [
    ...
    ; Ganha energia ao retornar ao ninho com comida
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; MOVIMENTAÇÃO DAS FORMIGAS(heurística de navegação)   ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
to uphill-chemical
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; FUNÇÕES AUXILIARES PARA SENSORIAL DAS FORMIGAS   ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; GERAÇÃO E COMPORTAMENTO DOS HUMANOS   ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
to spawn-human
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; PROCEDIMENTOS DOS SAPOS: CAÇA ENERGIA E REPRODUÇÃO   ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
to hunt-ants
  ...
  ifelse target != nobody [                   ; Se encontrou ao menos uma formiga
    ...
    ;  Se estiver se aproximando muito do ninho, vira para longe
